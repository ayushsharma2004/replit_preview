    ...
    <section id="services" className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <motion.h2 
            className="font-orbitron text-4xl font-bold mb-3 text-white"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
          >
            AI <span className="text-gradient glow">Solutions</span>
          </motion.h2>
          <motion.div 
        ...
        >
          {aiServices.map((service) => (
            ...
            >
              ...
              <h3 className="font-orbitron text-xl font-bold mb-4 text-white">{service.title}</h3>
              ...
              <button 
                ...
                className="inline-block font-orbitron text-white hover:text-white hover:underline transition-all"
              >
                Learn more <span className="ml-1 text-white">→</span>
              </button>
            </motion.div>
          ))}
        </motion.div>
